       ...
       private BanVeXeDbContext db = new BanVeXeDbContext();
        ...
        public ActionResult Create(post mpost)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                Message.set_flash("successfully added", "success");
        ...
        public ActionResult Status(int id)
        {
            ...
            db.Entry(mpost).State = EntityState.Modified;
            db.SaveChanges();
            Message.set_flash("Change the status successfully", "success");
            return RedirectToAction("Index");
        }
        ...
        public ActionResult deleteTrash(int id)
        {
            ...
            db.SaveChanges();
            Message.set_flash("Permanently deleted 1 Track", "success");
            return RedirectToAction("trash");
        }
    }
}
